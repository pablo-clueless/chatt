    ...
    <main className='w-full flex flex-col items-center px-5 md:px-52'>
      <div className='flex flex-col items-center my-10'>
        ...
        <Button
          label='join waitlist'
          to='/join-waitlist'
          className='bg-gray-700 text-white text-xl mt-10'
        />
      </div>
      ...
      <div className='w-full grid grid-cols-1 md:grid-cols-2 items-center justify-center bg-gray-500 rounded-lg my-7'>
        ...
        <div className='w-full flex flex-col'>
          ...
          label='join waitlist'
          to='join-waitlist'
          className='w-[200px] bg-gray-700 text-white mt-10'
        />
        </div>
      </div>
    </main>
